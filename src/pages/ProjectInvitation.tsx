...
export function InviteMember() {
    ...
    return (
        <div className="flex min-h-screen w-full bg-white dark:bg-gray-950 font-sans">
            <AsideNav workspaceId={wId} />
            <div className="relative flex-1 bg-white dark:bg-gray-950 text-gray-900 dark:text-gray-50 flex flex-col transition-colors duration-300 antialiased overflow-x-hidden">
                <FontFaces />

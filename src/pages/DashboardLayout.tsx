            ...
            <header className="flex h-16 items-center justify-between border-b border-sky-200/60 dark:border-cyan-400/10 bg-white/60 dark:bg-[#051923]/70 backdrop-blur-xl px-6 md:px-8 sticky top-0 z-40 gap-4 transition-colors">
                ...
                <div className="flex items-center gap-3 flex-shrink-0">
                    ...
                    <button
                        ...
                        className="h-9 w-9 flex items-center justify-center rounded-full text-sky-400 dark:text-cyan-400/50 hover:text-rose-500 dark:hover:text-rose-300 hover:bg-rose-500/10 dark:hover:bg-rose-400/10 transition-colors disabled:opacity-50"
                    >

...
export const ThemeToggle: React.FC = () => {
    ...
    return (
        <button
            onClick={toggleTheme}
            type="button"
            className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-xl border border-gray-200 bg-white/80 text-gray-500 shadow-sm backdrop-blur-md transition-all duration-200 hover:bg-gray-50 hover:text-gray-800 dark:border-gray-800 dark:bg-gray-900/80 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-gray-200 cursor-pointer"
                        ...
                        <div className="flex items-center gap-3.5 min-w-0">
                            ...
                            <div className="hidden sm:flex flex-col border-l border-gray-200 dark:border-gray-800 pl-4 min-w-0">
                                <div className="font-mono-nav flex items-center gap-2 text-[10px] font-semibold uppercase tracking-wider text-gray-400 dark:text-gray-500">
                                    ...
                                    <span>/</span>
                                    <span className="text-emerald-600 dark:text-emerald-400 font-bold">Assign Task</span>
                                </div>
                ...
                <div className="max-w-xl mx-auto p-4 sm:p-6 md:p-8 relative z-10 space-y-6">
                    ...
                    <div className="rounded-3xl bg-white/80 dark:bg-gray-900/60 border border-gray-200 dark:border-gray-800 p-6 sm:p-8 shadow-sm dark:shadow-none backdrop-blur-2xl relative overflow-hidden space-y-6">
                        ...
                        <div>
                            ...
                            <p className="font-mono-nav text-xs text-gray-500 dark:text-gray-400 mt-1 truncate">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="relative">
                                <Icon icon="solar:magnifer-linear" className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400 dark:text-gray-500" />
                                <input
                                    type="text"

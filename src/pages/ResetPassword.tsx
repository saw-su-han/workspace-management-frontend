        ...
        <div className="relative flex min-h-screen w-full flex-col items-center justify-between bg-white dark:bg-gray-950 px-4 py-6 text-gray-900 dark:text-gray-50 transition-colors duration-300 overflow-x-hidden font-sans">
            ...
            <div className="relative my-auto flex flex-col items-center max-w-xl w-full z-10 pt-32 pb-24">
                ...
                <div className="w-full border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900/60 backdrop-blur-xl p-6 sm:p-10 rounded-3xl shadow-xl space-y-6 relative overflow-hidden">
                    ...
                    {customError && (
                        <div className="flex items-center justify-center gap-2 rounded-xl bg-red-500/10 border border-red-500/20 p-3 text-xs font-semibold text-red-600 dark:text-red-400 text-center tracking-wide font-mono-nav">
                    ...
                    {successMsg && (
                        <div className="flex items-center justify-center gap-2 rounded-xl bg-mint-500/10 border border-mint-500/20 p-3 text-xs font-semibold text-mint-600 dark:text-mint-400 text-center tracking-wide font-mono-nav">
                    ...
                    <form className="space-y-4 relative z-10" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="relative">
                            ...
                            <button
                                ...
                                className="absolute right-3 top-[38px] text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 transition-colors p-1"
                        ...
                        <button
                            ...
                            className="font-mono-nav w-full mt-4 rounded-xl bg-mint-600 hover:bg-mint-500 text-white active:scale-[0.98] disabled:opacity-50 py-3.5 text-xs font-bold uppercase tracking-wider transition-all shadow-lg shadow-mint-600/20 cursor-pointer"
                        >
                    ...
                    <div className="mt-2 flex flex-col items-center gap-3 border-t border-gray-200 dark:border-gray-800 pt-5 text-xs font-medium text-gray-500 dark:text-gray-400 relative z-10">
                        <Link to="/login" className="font-mono-nav text-[11px] text-gray-400 hover:text-mint-600 dark:text-gray-500 dark:hover:text-mint-400 flex items-center gap-1 transition-colors">
                            ← Back to Login
                        </Link>
                    </div>
                </div>

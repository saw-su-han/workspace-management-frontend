            ...
            <div className="relative my-auto flex flex-col items-center max-w-xl w-full z-10 pt-32 pb-24">
                ...
                <div className="w-full border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900/60 backdrop-blur-xl p-6 sm:p-10 rounded-3xl shadow-xl space-y-6 relative overflow-hidden">
                            ...
                            <div className="flex justify-between gap-2 sm:gap-3" onPaste={handlePaste}>
                                {[0, 1, 2, 3, 4, 5].map((index) => (
                                    <input
                                        ...
                                        className="w-10 h-12 sm:w-12 sm:h-14 text-center font-mono-nav text-lg sm:text-xl font-bold rounded-xl border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white focus:outline-none focus:border-mint-500 focus:ring-2 focus:ring-mint-500/20 transition-all"
                                    />
                                ))}
                            </div>
                    ...
                    <div className="mt-2 flex flex-col items-center gap-3 border-t border-gray-200 dark:border-gray-800 pt-5 text-xs font-medium text-gray-500 dark:text-gray-400 relative z-10">
                        <Link to="/forgot-password" className="font-mono-nav text-[11px] text-gray-400 hover:text-mint-600 dark:text-gray-500 dark:hover:text-mint-400 flex items-center gap-1 transition-colors">
